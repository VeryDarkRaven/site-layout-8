...
function preloader () {
  ...
  function entryPercent (num = mediaItems.length) {
    ...
    num === mediaItems.length ? percents.innerHTML = 100 : calcPercent.toFixed(1);
  }
}
...
/***/ "./src/js/modules/spawn-animations.js":
/*!********************************************!*\
  !*** ./src/js/modules/spawn-animations.js ***!
  \********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      ...
      function animOnScroll () {
        if (scrollY > itemOffset - animItemPoint && scrollY < itemOffset + itemHeight || 
          ...
          if (!item.classList.contains("_anim-no-hide")) {
            item.classList.remove("_anim-active");
          }
        }
      }
    })
...
/* harmony import */ var _modules_mouse_move_parallax_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/mouse-move-parallax.js */ "./src/js/modules/mouse-move-parallax.js");
/* harmony import */ var _modules_change_scroll_header_bg_color_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/change-scroll-header-bg-color.js */ "./src/js/modules/change-scroll-header-bg-color.js");
/* harmony import */ var _modules_change_scroll_header_hidden_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/change-scroll-header-hidden.js */ "./src/js/modules/change-scroll-header-hidden.js");
/* harmony import */ var _modules_header_nav_item_click_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/header-nav-item-click.js */ "./src/js/modules/header-nav-item-click.js");
...
/* harmony import */ var _modules_video_player_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/video-player.js */ "./src/js/modules/video-player.js");
/* harmony import */ var _modules_courses_actions_buttons_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/courses-actions-buttons.js */ "./src/js/modules/courses-actions-buttons.js");
/* harmony import */ var _modules_hidden_placeholder_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/hidden-placeholder.js */ "./src/js/modules/hidden-placeholder.js");
...
/* harmony import */ var _modules_spawn_animations_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/spawn-animations.js */ "./src/js/modules/spawn-animations.js");
